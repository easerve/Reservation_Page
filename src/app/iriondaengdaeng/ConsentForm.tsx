            ...
            <div className="consent-terms">
              <div className="consent-terms">
                ...
                <div className="consent-terms-template-primary max-h-48 overflow-y-auto border p-4">
                  {/* <p>
                    본 매장은 미용 반려동물의 나이가 7세 이상이거나, 질병 또는
                    수술 경험이 있는 반려동물의 건강상태를 고려하여 아래와 같이
                    안내사항을 말씀 드리고, 이용 동의서를 받고자 합니다.
                  </p>
                  <p>
                  ...
                  <p>
                    동의서는 미용사와 보호자님 그리고 반려동물 모두 보호하겠다는
                    약속입니다.
                  </p>
                  <p>보호자님의 적극적인 협조를 부탁드립니다.</p>
                  <p>
                    애견 미용 서비스를 제공하는 매장과 애견 미용 서비스
                    이용자(이하 보호자)는 상호 간의 미용서비스와 관련하여 다음과
                    같이 동의를 계약합니다.
                  </p>
                  <p>
                    8살 이상의 반려견 들의 경우 노령화로 인한 질병 및
                    견주분들께서 미처 알지 못하고 계신 각종질환이 있을 수
                    있으며, 급작스런 스트레스로 인한 질환의 악화나 응급상황이
                    발생할 수 있음을 인지합니다.
                  </p>
                  <p>
                    그로 인해 원치 않는 일(스트레스 질환 및 쇼크사 등)이 발생할
                    수 있으므로, 본매장에서는 견주분으로부터 미용 중/미용 후
                    발생한 모든 책임(민,형사상 포함)을 묻지 않을 것임을 약속
                    받고 미용 해 드리고 있습니다.
                  </p>
                  <p>
                    본 매장은 반려견을 미용 함에 있어 소홀하지 않을 것 이며
                    반려견의 나이 및 노령화를 감안하여 최대한 배려하여 미용 할
                    것을 약속 드립니다.
                  </p>
                  <p>
                    동의서를 작성하셨더라도 반려견의 컨디션이나 건강상태가 좋지
                    않아 보일 시에는 미용사의 판단에 따라 미용이 중단 되실 수
                    있음을 인지합니다.
                  </p>
                  <p>
                  ...
                  <p>
                    애견 미용 시 발생할 수 있는 사고와 미용 후 스트레스 증후군에
                    대해 보호자는 인지를 하고 이해를 했으며 애견 미용 서비스를
                    이용하는 것을 동의합니다.
                  </p> */}
                  <p>
                    애견 미용 서비스를 제공하는 매장과 애견 미용 서비스
                  ...
                  <p> - 눈의 흰자위가 붉어지는 증상</p>
                  <p> - 이중모, 단모 강아지의 경우 클리퍼 사용 시 탈모 증상</p>
                  <p> - 체질에 따라 알러지성 피부염 증상</p>
                  <p>
                    {" "}
                    (1~2주 안에 위와 같은 증상은 사라지며 2주 이상 지속되는 경우
                    인근 동물 병원에 내방해주시기 바랍니다.)
                  </p>
                  <p>
                    2. 강아지의 모발 상태에 따라 원하는 스타일이 똑같이 안 나올
                    수 있음을 인지합니다.
                  </p>
                  <p>
                    3. 엉킨털이 있는 경우 푸는 데 시간이 오래 걸리고, 제거하다가
                    날이 손상되는 경우가 있기 때문에 엉킨털 미용 비용이 추가
                    발생할 수 있음을 인지합니다.
                  </p>
                  <p>
                    4. 미용 후 털에 감추어진 피부병이 발견될 수 있습니다. 이는
                    미용으로 인한 피부병이 아님을 인지합니다.
                  </p>
                  <p>
                    5. 강아지는 사람과 다르게 미용 중 계속 움직이다 보니 작은
                    스크래치가 생길 수 있음을 인지합니다.{" "}
                  </p>
                  <p>
                    {" "}
                  ...
                  <p>
                    {" "}
                    (미용 중에 발생한 상해에 따른 반려동물 치료비 외에 그 밖의
                    보호자에 대한 위자료나 기타 비용은 적용되지 않습니다.)
                  </p>
                  <p>
                  ...
                  <p>
                    {" "}
                    미용사가 물리면 정도에 따라 정상적인 영업 활동을 못하기에
                    손해배상 청구가 발생할 수 있음을 인지합니다.
                  </p>
                  <p>
                    <br />
                  </p>
              ...
              <div className="consent-terms mt-4">
                ...
                <div className="consent-terms-template-primary max-h-48 overflow-y-auto border p-4">
                  <p>
                    주식회사 프릿지크루(이하 '회사')는 대상 매장 예약 처리를
              ...
              <div className="consent-terms mt-4">
                ...
                <div className="consent-terms-template-primary max-h-48 overflow-y-auto border p-4">
                  <p>
                    주식회사 프릿지크루(이하 "회사")는 이용자의 개인정보를 본
                  ...
                  <ol>
                    ...
                    <li>제공받는 자 : 예약 매장</li>
                    <li>
                      제공정보 : 이름, 연락처, 이메일, 서비스 이용 기록,
                      반려동물명, 품종, 성별, 동물 등록번호, 중성화 수술 여부,
                      생년월일, 주소 등
                    </li>
                    <li>
